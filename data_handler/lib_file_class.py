...
class LoadDirectory:
    def __init__(self, dir_filename: str, save_name: str, delim_extension: str, /, *,
                 earth_save_name: str = 'gearthcoord_save', device_id: _Union[int, str]='1', folder_name: str='data') -> None:
        '''
    ...
    def appendEarthCoord(self, coords: _Coordinate, /, *, color: _Union[str, tuple[int, int, int, int]]='ff00ffff') -> str:
        '''
        ...
        '''
        earth_coord_0 = '<kml xmlns="http://www.opengis.net/kml/2.2" xmlns:gx="http://www.google.com/kml/ext/2.2">\n' +\
                        '<Folder>\n' +\
                        '\t<name>Log</name>\n' +\
                        '\t<Placemark>\n' +\
        ...
        with open(self.path_temp_coord, mode='a+') as f_temp, \
             open(self.path_earth_coord, mode='w') as f_gearth, \
             open(self.path_save_coord, mode='w') as f_save:
    ...
    def appendDelimitedFile(self, raw_data: _Union[list, str], /, *, delimiter=',') -> str:
        '''
    ...
    def dictToList(self, raw_dict: _Union[_Dict, dict], tuple_data: _Union[list, tuple, set, dict]) -> list:
